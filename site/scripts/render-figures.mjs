  ...
  return {
    ...
    node: frame({
      ...
      notes: [
        ...
        "No journal peer review, no field validation and no commercial-simulator comparison is claimed. Hosted continuous integration runs, and it is this repository checking itself, not an independent party checking it.",
