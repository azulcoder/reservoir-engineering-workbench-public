...
const SHOTS = [
  ...
  ["a4-hero", "/studies/a4/", 1440, false, "#hero", "A4 hero figure: is the conclusion visible in one figure?"],
  ["a4-result", "/studies/a4/", 1440, false, "#implication", "A4 engineering implication"],
  ["a4-supporting", "/studies/a4/", 1440, false, "#behaviour", "A4 primary supporting evidence"],
  ["a4-holdout", "/studies/a4/", 1440, false, "#holdout", "A4 holdout section"],
  ["a4-technical", "/studies/a4/", 1440, false, "#technical", "A4 transition into technical evidence"],
